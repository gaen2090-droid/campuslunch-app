...
List<Map<String, dynamic>> _mockRestaurants() => [
      ...
      _row(
        ...
        emoji: '🍙',
        imageUrl:
            'https://images.unsplash.com/photo-1635363638580-c2809d049eee?w=600&q=80&fit=crop',
        distance: 450,
        x: 35,
        y: 70,
        hours: '07:30 - 20:00',
      ...
      _row(
        ...
        reports: <String, int>{},
        menu: [
          {'name': '마라탕 (100g당)', 'price': 1200},
          {'name': '마라샹궈 (100g당)', 'price': 1500},
          {'name': '탕수육', 'price': 9000},
        ],
        lat: 37.56670,
        lng: 126.97820,
      ...
      _row(
        ...
        menu: [
          ...
          {'name': '쇼유 라멘', 'price': 8500},
          {'name': '미소 라멘', 'price': 8500},
          {'name': '차슈 추가', 'price': 2000},
        ],
        lat: 37.56720,
        lng: 126.97920,
      ),
